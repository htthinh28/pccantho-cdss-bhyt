...
**Ghi chú kỹ thuật CDSS:** Engine dự án (`du_lieu_luat_thuoc_muc8.jsx`, `dong_co_giam_dinh.jsx`) **có thể chưa** mã hóa đầy đủ từng ô cột (4)–(8) cho mọi hoạt chất; giám định viên và AI vẫn phải **đối chiếu Phụ lục I** khi kết luận thanh toán theo **hạng bệnh viện** và **điều kiện cột (8)**.
...
| Cột | Nội dung (ý chính) | Ý nghĩa giám định thanh toán |
|-----|---------------------|------------------------------|
...
|--------|-----------------------------------|
| Tên cơ sở | **Bệnh viện Quốc tế Phương Châu Sóc Trăng** |
| **`MA_CSKCB`** | **`94170`** |
...
1. Xác định `MA_CSKCB` trên XML1 — với **Phương Châu Sóc Trăng** là **`94170`** — hoặc tên cơ sở khớp **Bệnh viện Quốc tế Phương Châu** (hoặc chi nhánh được quy ước cùng nhóm hạng).  
